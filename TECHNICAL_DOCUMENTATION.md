...
**Telegram Currency Converter Bot** — это асинхронный бот для Telegram, предоставляющий функционал конвертации валют в реальном времени с поддержкой множественных поставщиков данных, автоматического обновления курсов, системы уведомлений (watches) и опционального хранения истории.
